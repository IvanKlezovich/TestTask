...
class TransferServiceImplTest {
    ...
    void setUp() {
        ...
        lenient().when(accountRepository.findById(eq(1L))).thenReturn(java.util.Optional.of(senderAccount));
        lenient().when(accountRepository.findById(eq(2L))).thenReturn(java.util.Optional.of(recipientAccount));
    }
